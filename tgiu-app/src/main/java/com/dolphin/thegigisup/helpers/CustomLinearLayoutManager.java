...
/**
 * A custom linear layout manager used for RecyclerViews
 *
 * @author Team Dolphin 04/03/15.
 */
public class CustomLinearLayoutManager extends LinearLayoutManager {
    ...
    /**
     * Custom on measure method that measures the size of the RecyclerView
     */
    @Override
    ...
    /**
     * Custom on measure method that measures the scrap child views
     */
    private void measureScrapChild(RecyclerView.Recycler recycler,
                                   int position, int widthSpec,
